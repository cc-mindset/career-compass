...
How to find vectorIds:
  ...
  3. The URL will update with the vector ID, or use:
     GET https://www150.statcxan.gc.ca/t1/wds/rest/getSeriesInfoFromCubePidCoord
...
# --- REGISTRY START (managed by step2_remap_registry.py) ---

# LFS Employment by industry, monthly SA (14-10-0355-01)
LFS_EMPLOYMENT = [
    (   2057603,  "Canada - total employment",  "employment_level",  "Total Industries",  "all",  "national",  "national",  "monthly",  "14-10-0355-01"),
    (   2057604,  "Canada - goods-producing employment",  "employment_level",  "Goods-Producing",  "all",  "national",  "national",  "monthly",  "14-10-0355-01"),
    (   2057610,  "Canada - services-producing employment",  "employment_level",  "Services-Producing",  "all",  "national",  "national",  "monthly",  "14-10-0355-01"),
    (   2057609,  "Canada - manufacturing employment",  "employment_level",  "Manufacturing",  "31",  "national",  "national",  "monthly",  "14-10-0355-01"),
    (   2057608,  "Canada - construction employment",  "employment_level",  "Construction",  "23",  "national",  "national",  "monthly",  "14-10-0355-01"),
    (   2057613,  "Canada - finance insurance real estate employment",  "employment_level",  "Finance Insurance Real Estate",  "52",  "national",  "national",  "monthly",  "14-10-0355-01"),
    (   2057614,  "Canada - professional scientific technical employment",  "employment_level",  "Professional Scientific Technical",  "54",  "national",  "national",  "monthly",  "14-10-0355-01"),
...
LFS_OCCUPATION = [
    ...
    (1490031881,  "Canada - unemployment management occupations",  "unemployment_rate",  "Management Occupations",  "NOC-0",  "national",  "national",  "monthly",  "14-10-0421-01"),
    (1490031896,  "Canada - unemployment business finance admin",  "unemployment_rate",  "Business Finance Admin",  "NOC-1",  "national",  "national",  "monthly",  "14-10-0421-01"),
    (1490031917,  "Canada - unemployment natural applied sciences",  "unemployment_rate",  "Natural and Applied Sciences",  "NOC-2",  "national",  "national",  "monthly",  "14-10-0421-01"),
    (1490031935,  "Canada - unemployment health occupations",  "unemployment_rate",  "Health Occupations",  "NOC-3",  "national",  "national",  "monthly",  "14-10-0421-01"),
    (1490031956,  "Canada - unemployment education law social",  "unemployment_rate",  "Education Law Social Services",  "NOC-4",  "national",  "national",  "monthly",  "14-10-0421-01"),
    (1490032004,  "Canada - unemployment sales service",  "unemployment_rate",  "Sales and Service",  "NOC-6",  "national",  "national",  "monthly",  "14-10-0421-01"),
    (1490032019,  "Canada - unemployment trades transport",  "unemployment_rate",  "Trades Transport Equipment",  "NOC-7",  "national",  "national",  "monthly",  "14-10-0421-01"),
    (1490032043,  "Canada - unemployment manufacturing utilities",  "unemployment_rate",  "Manufacturing and Utilities",  "NOC-9",  "national",  "national",  "monthly",  "14-10-0421-01"),
    (1490031197,  "Canada - employment natural applied sciences",  "employment_level",  "Natural and Applied Sciences",  "NOC-2",  "national",  "national",  "monthly",  "14-10-0421-01"),
    (1490031215,  "Canada - employment health occupations",  "employment_level",  "Health Occupations",  "NOC-3",  "national",  "national",  "monthly",  "14-10-0421-01"),
    (1490031236,  "Canada - employment education law social",  "employment_level",  "Education Law Social Services",  "NOC-4",  "national",  "national",  "monthly",  "14-10-0421-01"),
]

# JVWS Job vacancies by industry sub-sector, quarterly (14-10-0442-01)
JVWS = [
    (1568389348,  "Canada - total job vacancy rate",  "vacancy_rate",  "Total Industries",  "all",  "national",  "national",  "quarterly",  "14-10-0442-01"),
    (1568389396,  "Canada - professional scientific vacancy rate",  "vacancy_rate",  "Professional Scientific Technical",  "54",  "national",  "national",  "quarterly",  "14-10-0442-01"),
    (1568389384,  "Canada - information culture vacancy rate",  "vacancy_rate",  "Information Culture Recreation",  "51",  "national",  "national",  "quarterly",  "14-10-0442-01"),
    (1568389388,  "Canada - finance insurance vacancy rate",  "vacancy_rate",  "Finance Insurance",  "52",  "national",  "national",  "quarterly",  "14-10-0442-01"),
    (1568389412,  "Canada - health care vacancy rate",  "vacancy_rate",  "Health Care and Social Assistance",  "62",  "national",  "national",  "quarterly",  "14-10-0442-01"),
    (1568389368,  "Canada - manufacturing vacancy rate",  "vacancy_rate",  "Manufacturing",  "31",  "national",  "national",  "quarterly",  "14-10-0442-01"),
    (1568389364,  "Canada - construction vacancy rate",  "vacancy_rate",  "Construction",  "23",  "national",  "national",  "quarterly",  "14-10-0442-01"),
    (1568389420,  "Canada - accommodation food vacancy rate",  "vacancy_rate",  "Accommodation and Food Services",  "72",  "national",  "national",  "quarterly",  "14-10-0442-01"),
    (1568389349,  "Canada - total average offered hourly wage",  "wage_level",  "Total Industries",  "all",  "national",  "national",  "quarterly",  "14-10-0442-01"),
    (1568389397,  "Canada - professional scientific offered wage",  "wage_level",  "Professional Scientific Technical",  "54",  "national",  "national",  "quarterly",  "14-10-0442-01"),
    (1568389385,  "Canada - information culture offered wage",  "wage_level",  "Information Culture Recreation",  "51",  "national",  "national",  "quarterly",  "14-10-0442-01"),
    (1568389413,  "Canada - health care offered wage",  "wage_level",  "Health Care and Social Assistance",  "62",  "national",  "national",  "quarterly",  "14-10-0442-01"),
]

# SEPH Avg weekly earnings + employment by industry, monthly SA (14-10-0220-01)
SEPH = [
    (1544383949,  "Canada - total avg weekly earnings all industries",  "wage_level",  "Total Industries",  "all",  "national",  "national",  "monthly",  "14-10-0220-01"),
    (  54026391,  "Canada - manufacturing avg weekly earnings",  "wage_level",  "Manufacturing",  "31",  "national",  "national",  "monthly",  "14-10-0220-01"),
    (  54026363,  "Canada - construction avg weekly earnings",  "wage_level",  "Construction",  "23",  "national",  "national",  "monthly",  "14-10-0220-01"),
    (  54026853,  "Canada - finance insurance avg weekly earnings",  "wage_level",  "Finance Insurance Real Estate",  "52",  "national",  "national",  "monthly",  "14-10-0220-01"),
    (  54026917,  "Canada - professional scientific avg weekly earnings",  "wage_level",  "Professional Scientific Technical",  "54",  "national",  "national",  "monthly",  "14-10-0220-01"),
    (  54026965,  "Canada - health care avg weekly earnings",  "wage_level",  "Health Care and Social Assistance",  "62",  "national",  "national",  "monthly",  "14-10-0220-01"),
    (  54026819,  "Canada - information culture avg weekly earnings",  "wage_level",  "Information Culture Recreation",  "51",  "national",  "national",  "monthly",  "14-10-0220-01"),
    (  54027035,  "Canada - accommodation food avg weekly earnings",  "wage_level",  "Accommodation and Food Services",  "72",  "national",  "national",  "monthly",  "14-10-0220-01"),
    (  54026324,  "Canada - total payroll employment all industries",  "employment_level",  "Total Industries",  "all",  "national",  "national",  "monthly",  "14-10-0220-01"),
    (  54026918,  "Canada - professional scientific payroll employment",  "employment_level",  "Professional Scientific Technical",  "54",  "national",  "national",  "monthly",  "14-10-0220-01"),
