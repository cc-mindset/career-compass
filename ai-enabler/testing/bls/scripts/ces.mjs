...
const outputDir = path.join(rootDir, 'bls', 'outputs', 'ces');
...
async function main() {
  ...
  const seriesIds = (process.env.CES_SERIES_IDS || 'CES0000000001,CES3000000001,CES6000000001,CES6500000001,CES7000000001,CES5000000001,CES0500000003')
    .split(',')
  ...
  const rawPath = path.join(outputDir, `ces-${stamp}.json`);
  const reportPath = path.join(outputDir, `ces-${stamp}.report.json`);
