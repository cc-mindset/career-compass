...
const inferCompletedSections = (insights: MarketInsightsPayload): string[] => {
  ...
  // market_news was removed from the Part 3 prompt (2026-09) — report_sources and
  // evidence_lens_coverage are still generated by that section, so use those as the
  // "did this section respond" signal instead.
  if (insights.report_sources || insights.evidence_lens_coverage) {
