...
const MoleculesPage: React.FC = () => {
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-extrabold mb-2 text-slate-900 dark:text-white">Molecules</h1>
      ...
      {/* InsightsCard */}
      <section>
        <h2 className="text-2xl font-bold mb-4 text-slate-900 dark:text-white">InsightsCard</h2>
      ...
      {/* PivotCard */}
      <section>
        <h2 className="text-2xl font-bold mb-4 text-slate-900 dark:text-white">PivotCard</h2>
        <div className="space-y-4">
          <PivotCard
      ...
      {/* StatCard */}
      <section>
        <h2 className="text-2xl font-bold mb-4 text-slate-900 dark:text-white">StatCard</h2>
