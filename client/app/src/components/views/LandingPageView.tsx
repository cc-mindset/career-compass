          ...
          <div className="bg-white rounded-[2rem] border border-indigo-400/30 md:border-2 md:border-indigo-400/30 shadow-2xl shadow-indigo-500/10 p-2 md:p-2.5 flex flex-col md:flex-row items-center gap-3">
            ...
            <div className="flex-1 w-full flex items-center gap-4 px-4 min-h-[52px]">
              ...
              <div className="flex-1 text-left relative" ref={dropdownRef}>
                ...
                >
                  <h3 className={`font-bold text-slate-900 md:group-hover:text-indigo-600 truncate transition-colors duration-200 ${
                  ...
                  <ChevronRight className={`w-4 h-4 text-slate-300 md:group-hover:text-indigo-600 transition-all duration-300 ml-2 ${isOpen ? 'rotate-90' : ''}`} />
                </div>
...
const FeatureHoverItem: React.FC<FeatureHoverItemProps> = ({ index, icon, title, description, isOpen, onToggle }) => {
  ...
  return (
    <div ref={featureRef} className="group relative flex flex-col items-center">
      ...
      <div className={`absolute bottom-full mb-4 sm:mb-6 ${getMobilePosition()} w-64 p-4 sm:p-5 bg-white rounded-xl sm:rounded-2xl border border-slate-200 shadow-2xl shadow-indigo-500/10 z-50 transition-all duration-300 ${
        isOpen 
        ...
        <h4 className="font-bold text-slate-900 mb-1.5 sm:mb-2 text-sm">{title}</h4>
