    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 pb-20">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 md:gap-6 mb-8 md:mb-12">
        <div className="min-w-0">
          ...
          <p className="text-slate-500 text-sm sm:text-base">Personalized strategic roadmap generated by Gemini for your specific role and market</p>
        </div>
        
        <button 
          onClick={fetchSuggestions}
          disabled={loading}
          className="flex items-center justify-center gap-2 bg-indigo-50 text-indigo-600 px-5 py-2.5 sm:px-6 sm:py-3 rounded-xl sm:rounded-2xl font-bold hover:bg-indigo-100 transition-all border border-indigo-100 disabled:opacity-50 touch-manipulation w-fit"
        >
