      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 md:gap-12 xl:gap-20 items-start">
        ...
        <div className="lg:col-span-2 lg:pl-12">
          <div className="flex flex-col items-center text-center w-full max-w-sm mx-auto lg:mx-0">
            ...
            <div className="w-full">
              <h2 className="text-2xl sm:text-3xl font-extrabold mb-1 tracking-tight text-slate-900">{user.name}</h2>
              <p className="text-indigo-600 font-bold text-base sm:text-lg mb-3">{user.role}</p>
        ...
        <div className="lg:col-span-3">
          ...
          <div className="mb-4 md:mb-6 flex items-center gap-3">
             ...
             <h2 className="text-lg sm:text-xl font-bold tracking-tight text-slate-900">Compass</h2>
          </div>

          {/* Cards */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 xl:gap-6 mb-10 md:mb-16">
            <StatCard icon={<Newspaper />} count={24} label="New Articles" trend="+12%" color="bg-blue-50 text-blue-600" />
            <StatCard icon={<GraduationCap />} count={16} label="Courses" trend="+8%" color="bg-purple-50 text-purple-600" />
            <StatCard icon={<Lightbulb />} count={8} label="Suggestions" trend="New" color="bg-amber-50 text-amber-600" />
            <StatCard icon={<MapPin />} count={3} label="Paths" status="Active" color="bg-emerald-50 text-emerald-600" />
          </div>
          ...
          <div>
            <div className="mb-4 md:mb-6 flex items-center gap-3">
               ...
               <h2 className="text-lg sm:text-xl font-bold tracking-tight text-slate-900">Top Skills</h2>
            </div>
