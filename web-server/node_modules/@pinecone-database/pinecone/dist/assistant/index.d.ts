...
import type { ChatCompletionOptions, ChatOptions, ContextOptions, ListFilesOptions, UploadFileOptions } from '@pinecone-database/pinecone/dist/assistant/data/types';
import { chatCompletion } from '@pinecone-database/pinecone/dist/assistant/data/chatCompletion';
import { chatStream } from '@pinecone-database/pinecone/dist/assistant/data/chatStream';
import { chatCompletionStream } from '@pinecone-database/pinecone/dist/assistant/data/chatCompletionStream';
import { listFiles } from '@pinecone-database/pinecone/dist/assistant/data/listFiles';
import { describeFile } from '@pinecone-database/pinecone/dist/assistant/data/describeFile';
import { deleteFile } from '@pinecone-database/pinecone/dist/assistant/data/deleteFile';
import { uploadFile } from '@pinecone-database/pinecone/dist/assistant/data/uploadFile';
import { PineconeConfiguration } from '@pinecone-database/pinecone/dist/data';
import { context } from '@pinecone-database/pinecone/dist/assistant/data/context';
export type { CreateAssistantOptions, UpdateAssistantOptions, UpdateAssistantResponse, AssistantStatusEnum, AssistantModel, AssistantList, } from '@pinecone-database/pinecone/dist/assistant/control/types';
export type { ChatOptions, ChatContextOptions, ChatCompletionOptions, ChatModelEnum, ChoiceModel, FinishReasonEnum, StreamedChatResponse, StreamedChatCompletionResponse, BaseChunk, MessageStartChunk, ContentChunk, CitationChunk, MessageEndChunk, ContextOptions, ListFilesOptions, UploadFileOptions, AssistantFileModel, AssistantFileStatusEnum, AssistantFilesList, } from '@pinecone-database/pinecone/dist/assistant/data/types';
export { ChatStream } from '@pinecone-database/pinecone/dist/assistant/chatStream';
/**
...
export declare class Assistant {
     ...
     */
    chat(options: ChatOptions): Promise<import("@pinecone-database/pinecone").ChatModel>;
    /**
     ...
     */
    chatStream(options: ChatOptions): Promise<import("@pinecone-database/pinecone/dist/assistant/chatStream").ChatStream<import("@pinecone-database/pinecone/dist/assistant/data/types").StreamedChatResponse>>;
    /**
     ...
     */
    chatCompletion(options: ChatCompletionOptions): Promise<import("@pinecone-database/pinecone").ChatCompletionModel>;
    /**
     ...
     */
    chatCompletionStream(options: ChatCompletionOptions): Promise<import("@pinecone-database/pinecone/dist/assistant/chatStream").ChatStream<import("@pinecone-database/pinecone/dist/assistant/data/types").StreamedChatCompletionResponse>>;
    /**
     ...
     */
    listFiles(options?: ListFilesOptions): Promise<import("@pinecone-database/pinecone/dist/assistant/data/types").AssistantFilesList>;
    /**
     ...
     */
    describeFile(fileId: string, includeUrl?: boolean): Promise<import("@pinecone-database/pinecone/dist/assistant/data/types").AssistantFileModel>;
    /**
     ...
     * @returns A promise that resolves to a {@link AssistantFileModel} object containing the file details.
     */
    uploadFile(options: UploadFileOptions): Promise<import("@pinecone-database/pinecone/dist/assistant/data/types").AssistantFileModel>;
    /**
     ...
     */
    context(options: ContextOptions): Promise<import("@pinecone-database/pinecone").ContextModel>;
}
